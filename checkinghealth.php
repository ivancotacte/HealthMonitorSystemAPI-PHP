            ...
            <div class="row align-items-center">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="heartRate" id="showHeartRate" name="heartRate" class="form-control bg-light fs-6" placeholder="00">
                    </div>      
                    <label for="showWeight" class="form-label">Weight (kg):</label>   
                    <div class="input-group mb-3">
                        <input type="weight" id="showWeight" name="weight" class="form-control bg-light fs-6" placeholder="00">
                    </div> 
