<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($updateResult) {
            ...
            $current_time = date("F d, Y h:i:s A");
            ...
            $stmt = $conn->prepare("UPDATE tbl_users SET ai_response = ? WHERE IDNumber = ?");
            $stmt->execute([$ai_reply, $id]);
            ...
            <body>
            <p>Dear <strong>" . ucfirst($result['firstName']) . " " . ucfirst($result['lastName']) . ",</strong></p>
                ...
                <div class="row align-items-center">
                    ...
                    <form id="myForm" action="" method="post" novalidate>
                        ...
                        <div class="input-group">
                            <button type="submit" name="submit" class="btn btn-lg w-100 fs-6" style="background-color: #000000; color: #ececec;">
                                Submit
                            </button>
                        </div>
                    </form>
